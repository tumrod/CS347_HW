...
DROP TABLE SIM_task CASCADE CONSTRAINTS ;
...
ALTER TABLE SIM_task ADD CONSTRAINT SIM_task_PK PRIMARY KEY ( task_id ) ;
...
ALTER TABLE SIM_task ADD CONSTRAINT SIM_task_SIM_Person_FK FOREIGN KEY ( SIM_Person_person_id ) REFERENCES SIM_Person ( person_id ) ;

ALTER TABLE SIM_task ADD CONSTRAINT SIM_task_SIM_project_FK FOREIGN KEY ( SIM_project_project_id ) REFERENCES SIM_project ( project_id ) ;
